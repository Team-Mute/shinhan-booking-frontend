...
export default function InvitationPage() {
    ...
    if (loading) return <StatusContainer>초대장을 불러오는 중입니다...</StatusContainer>;
    if (error) return <StatusContainer error>오류: {error}</StatusContainer>;
    if (!invitation) return <StatusContainer error>초대장 정보를 찾을 수 없습니다.</StatusContainer>;
    ...
    return (
        <Container>
            <Content>
                <Title>
                    {invitation.userName}님으로부터<br />초대장이 도착했어요!
                </Title>
